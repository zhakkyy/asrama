...
<body>
  ...
  <div class="navbar-fixed">
    ...
    <ul class="side-nav fixed">
      ...
      <li class ="white"><a href="admin_deskripsi.php"><i class="material-icons">assignments</i>Deskripsi</a></li> <!--baru-->
  ...
  <!--Content Tetap Ditengah-->
    <div class="container">
      ...
      <div class="section no-pad-bot" id="index-banner">
        ...
        <?php
          $id=$_GET['id'];
          $query = mysqli_query($db,"SELECT * FROM soal_ei WHERE idsoal_ei='$id'");
