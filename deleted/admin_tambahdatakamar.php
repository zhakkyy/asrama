...
<html>
<head>
  <title>Tambah Data Kamar | Admin Page</title>
  ...
  <!--Content Tetap Ditengah-->
    <div class="container">
      ...
      <div class="section no-pad-bot" id="index-banner">
        ...
        <!--Table Tambah Gedung-->
        <div class="row">
          <form class="col s12" action="inc/admin_tambahdatakamar.php" method="POST">
            <div class="row">
              <div class="input-field col s8">
                <input name ="nama_kamar" id="nama_kamar" type="text" class="validate" style="width:50%" required>
            ...
            <label>Gedung Asrama</label>
               <select name="nama_gedung" id="nama_gedung" class="browser-default" style="width:50%" required>
