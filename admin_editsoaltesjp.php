  ...
  <!--Content Tetap Ditengah-->
    <div class="container">
      ...
      <div class="section no-pad-bot" id="index-banner">
        ...
        <?php
          $id=$_GET['id'];
          $query = mysqli_query($db,"SELECT * FROM soal_jp WHERE idsoal_jp='$id'");
          $row = mysqli_fetch_array ($query);

        ?>
        <form action="inc/admin_editsoaltesjp.php" method="post">
        ...
        <table id="soal" class="table pmd-table table-hover table-striped display responsive nowrap" cellspacing="0" width="50%">
          <tr>
            <td>Soal Judging  : </td>
            <td><input type="text" name="soal_j" id="soal_j" size="25" type="text" class="validate" value="<?php echo $row['soal_j'];?>"></td>
          </tr>
          <tr>
            <td>Soal Perceiving  : </td>
            <td><input type="text" name="soal_p" id="soal_p" size="25" type="text" class="validate" value="<?php echo $row['soal_p'];?>"></td><!--baru diubah-->
          </tr>
